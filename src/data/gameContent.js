...
export const eventDatabase = [
  ...
  },
  {
    ...
    factionId: 'old_nobles',
    conditionId: 'queen_salon_ready',
    weight: 7,
    characterIds: ['queen_isabella', 'lord_pei'],
    title: '王后安排宗室茶会',
    desc: '你前脚才从王后寝宫出来，后脚伊莎贝拉就让人递话：几位宗室女眷和老贵族夫人都在偏殿候着，想借这份“难得的恩宠”顺便同你叙叙旧。',
    choices: [
      { id: 'queen_salon_grand', tierId: 'high', text: '【赏脸到底】既然都来了，就把体面做足。 (耗国库, 稳权威)', energy: 18, requirementId: 'always', effectId: 'queen_salon_grand', factionEffects: { old_nobles: 2 } },
      { id: 'queen_salon_selective', tierId: 'mid', text: '【点到为止】见几位关键人物，别把整个下午都赔进去。 (中耗, 稳态收益)', energy: 10, requirementId: 'always', effectId: 'queen_salon_selective', factionEffects: { old_nobles: 1 } },
      { id: 'queen_salon_decline', tierId: 'low', text: '【改日再说】今天只陪王后，不陪整屋子的旧贵族。 (省精力, 掉体面)', energy: 0, requirementId: 'always', effectId: 'queen_salon_decline', factionEffects: { merchants: 1 } },
    ],
  },
  {
    id: 'e_mistress_credit',
    tag: '午后后续',
    icon: 'fa-wine-bottle',
    color: 'text-pink-300',
    factionId: 'merchants',
  ...
  },
  {
    ...
    color: 'text-red-200',
    factionId: 'military',
    conditionId: 'hunt_camp_ready',
    weight: 7,
    characterIds: ['general_han'],
    title: '猎场边的军情酒会',
    desc: '围猎散场后，韩烈带着一群将校围住篝火，硬把你请到主位。酒还没温热，他们就开始借着豪气谈粮草、禁卫和边军赏格，显然不是单纯想陪你喝一杯。',
    choices: [
      { id: 'hunt_camp_bonus', tierId: 'high', text: '【借酒加码】趁他们士气正高，把赏格和补给一起拍板。 (耗国库, 强化军心)', energy: 16, requirementId: 'always', effectId: 'hunt_camp_bonus', factionEffects: { military: 2 } },
      { id: 'hunt_camp_drill', tierId: 'mid', text: '【只谈操练】给面子，但先不把钱和宫门都交出去。 (中耗, 较平衡)', energy: 10, requirementId: 'always', effectId: 'hunt_camp_drill', factionEffects: { military: 1 } },
      { id: 'hunt_camp_rebuke', tierId: 'low', text: '【收起酒碗】猎场归猎场，军国大事回朝再议。 (省精力, 伤军心)', energy: 0, requirementId: 'always', effectId: 'hunt_camp_rebuke', factionEffects: { old_nobles: 1 } },
    ],
  },
  {
    id: 'e_spy_dossier',
    ...
    factionId: 'foreign',
    conditionId: 'spy_dossier_ready',
    weight: 7,
    characterIds: ['spymaster_ruan'],
    title: '阮青崖递上密档',
    desc: '情报暗室散场时，阮青崖把一册薄薄的密档塞进你袖中。里面写满了不能见光的把柄：谁收了谁的钱，谁又偷偷见了谁。问题不在真假，而在你想拿它做什么。',
    choices: [
      { id: 'spy_dossier_strike', tierId: 'high', text: '【当朝敲打】拿一两页出来吓唬人，让他们记住谁还坐在王座上。 (增权威, 提压力)', energy: 12, requirementId: 'always', effectId: 'spy_dossier_strike', factionEffects: { foreign: 1, old_nobles: 1 } },
      { id: 'spy_dossier_blackmail', tierId: 'mid', text: '【换成现钱】秘密不一定要公开，也可以直接换银子。 (补国库, 留污点)', energy: 8, requirementId: 'always', effectId: 'spy_dossier_blackmail', factionEffects: { merchants: 1, foreign: 1 } },
      { id: 'spy_dossier_bury', tierId: 'low', text: '【先压柜里】有些东西知道就够了，不必今天就动。 (省精力, 降压力)', energy: 0, requirementId: 'always', effectId: 'spy_dossier_bury', factionEffects: { foreign: 1 } },
    ],
  },
  {
